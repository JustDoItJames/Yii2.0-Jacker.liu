...
class RequestCore
{
	...
	public function prep_request()
	{
        ...
        //选项CURLOPT_CLOSEPOLICY已被废弃，它不会被实现。PHP 5.6.0 中移除。
	...
	public function process_response($curl_handle = null, $response = null)
	{
		...
		if (is_resource($this->curl_handle))
		{
			...
			if ($curl_handle && $response)
			{
				return new \app\oss_php_sdk\lib\ResponseCore($this->response_headers, $this->response_body, $this->response_code, $this->curl_handle);
			}
		}
